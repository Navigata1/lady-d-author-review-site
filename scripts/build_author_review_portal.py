...
payment='''<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Lady D Stripe Payment Update Status</title><style>'''+page_css()+'''</style></head><body><nav class="topbar"><span class="brand">Lady D Admin</span><a href="index.html">Author portal</a></nav><main class="wrap"><section class="card notice"><h1>Stripe payment update status</h1><p><strong>Live update blocked by Stripe restricted-key permissions.</strong> The account can read live objects, but live Products/Prices/Payment Links cannot be created with the current key.</p><p>Verified live account: charges enabled, payouts enabled, details submitted. Existing live old link <code>plink_1TXXTnQQMWQl4qqGlKOQYsxs</code> remains active at $400 and should not be sent for the expanded package.</p><h2>Manual Dashboard fields needed</h2><ul><li>Product/name: Susan Damon - Expanded Publishing Package Remaining Balance</li><li>Amount: $2,300.00 USD</li><li>Description: Remaining balance for expanded publishing package: 3 devotional books + companion journals + 31-day visual devotional + Juan R. Damon testimony book</li><li>Metadata: client=Susan Damon; project=Expanded Publishing Package; package_total=2500; paid_credit=200; remaining_balance=2300</li></ul><p>Important: an accidental TEST-mode link was created during CLI retry and immediately deactivated. It is not live and is not exposed in the author portal.</p></section></main></body></html>'''
