...
def dashboard_html(commit: str) -> str:
    ...
    completed = [
        ...
        "Volume 1 January Days 001-031 author-voice line edits completed across four seven-day batches plus a three-day month closeout with 31 varied morning-impact lines, zero old Volume 1 impact templates, zero internal production labels, and zero Sunday mentions.",
    ]
    remaining = [
        ...
        "Remaining author-voice line edits after the completed Volume 1 January Days 001-031 batches.",
        "Author approval of companion journal rhythm and front/back matter.",
...
<body>
  <header>
    ...
    <p class="lead">The three devotional manuscripts are complete at the dated-entry level and now have master assemblies, companion journals, cover candidates, KDP trim math, devotional and companion journal full-wrap drafts, interior finalization templates, the first Volume 1 6 x 9 interior prototype, full 6 x 9 devotional drafts, full 6 x 9 companion journal drafts, a release-upload readiness pack, a trilogy proof/copyedit audit pack, a proof decision resolution pack, proof decision application evidence showing the prior 192-item queue now cleared, an author-voice copyedit gate, and the completed Volume 1 January author-voice line-edit surface covering Days 001-031. This dashboard separates what is complete from what still gates true KDP upload readiness.</p>
  ...
  <main>
    ...
    <section>
      ...
      <p class="lead">Volume 1 January Days 001-031 has moved from structural manuscript into line-edited review surface across four seven-day batches plus a three-day closeout. The edited January surface has 31 varied morning-impact lines, zero old Volume 1 impact templates, zero internal production labels, and zero Sunday mentions. This is continuing review progress, not final KDP upload approval.</p>
      <div class="grid">
        <article class="card">
        ...
        <article class="card">
          ...
          <h3>31 varied impacts</h3>
          <p>The repeated `Let the Father's love carry` impact frame has been removed from the completed January surface.</p>
        </article>
        <article class="card">
          <span>Guardrail</span>
          <h3>0 Sunday mentions</h3>
          <p>The Adventist Sabbath frame remains seventh-day/Saturday and obedience remains response to grace in the full edited January surface.</p>
        </article>
      </div>
      <div class="actions">
    ...
    <section>
      ...
      <p class="lead">Use the three devotional drafts, three companion journal drafts, release-upload readiness pack, trilogy proof audit pack, proof decision resolution pack, proof decision application pack, author-voice copyedit gate, and Volume 1 January Days 001-031 line-edit batches as the next copyedit and theological proof surface. Do not mark any file as final upload-ready until the remaining author-voice line edits, ISBN/barcode, paper type, Bible permissions, KDP Previewer, and physical proof review pass.</p>
