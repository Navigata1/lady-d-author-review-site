...
- Volume 1 Days 001-216, including Leap Day, author-voice line edits completed across twenty-nine seven-day batches, one eight-entry leap-day/March gate, plus a three-day January closeout and a three-day June closeout; the edited surface now has 217 varied morning-impact lines, zero old Volume 1 impact templates, zero internal production labels, and zero Sunday mentions.
...
- Continue author-voice line edits beyond the completed Volume 1 Days 001-216 plus Leap Day batches.
...
def dashboard_html(commit: str) -> str:
    ...
    completed = [
        ...
        "Author decision sheet generated with title, Bible policy, cover, front/back matter, launch order, Adventist guardrail, source-freeze, and KDP copy-economics approval fields.",
        "Volume 1 Days 001-216, including Leap Day, author-voice line edits completed across twenty-nine seven-day batches, one eight-entry leap-day/March gate, plus a three-day January closeout and a three-day June closeout with 217 varied morning-impact lines, zero old Volume 1 impact templates, zero internal production labels, and zero Sunday mentions.",
    ]
    remaining = [
        ...
        "Author approval of the decision sheet: titles, Bible policy, cover direction, bio, dedication, acknowledgments, and launch order.",
        "Remaining author-voice line edits after the completed Volume 1 Days 001-216 plus Leap Day batches.",
        "Author approval of companion journal rhythm and front/back matter.",
...
<body>
  ...
  <main>
    ...
    <section>
      ...
      <div class="grid">
        ...
        <article class="card">
          ...
          <p>The audit checks 369,606 source words and reports zero placeholders, zero Sunday mentions, and zero priority theology contexts requiring resolution.</p>
        </article>
        <article class="card">
    ...
    <section>
      ...
      <p class="lead">Volume 1 Days 001-216 plus Leap Day has moved from structural manuscript into line-edited review surface across twenty-nine seven-day batches, one eight-entry leap-day/March gate, plus a three-day January closeout and a three-day June closeout. The edited surface has 217 varied morning-impact lines, zero old Volume 1 impact templates, zero internal production labels, and zero Sunday mentions. This is continuing review progress, not final KDP upload approval.</p>
      <div class="grid">
        <article class="card">
        ...
        <article class="card">
          ...
          <h3>217 varied impacts</h3>
          <p>The repeated `Let the Father's love carry` impact frame has been removed from the completed Days 001-216 plus Leap Day surface.</p>
        </article>
        <article class="card">
          <span>Guardrail</span>
          <h3>0 Sunday mentions</h3>
          <p>The Adventist Sabbath frame remains seventh-day/Saturday and obedience remains response to grace in the full edited Days 001-216 plus Leap Day surface.</p>
        </article>
      </div>
      <div class="actions">
