...
for idx in [ROOT / "index.html", PUBLIC / "index.html"]:
    ...
    html = re.sub(
        ...
        '<nav class="topbar"><span class="brand">Lady D Author Review</span><a href="#books">Books</a><a href="susan-damon-hub.html">Publishing hub</a><a href="susan-damon-publishing-proposal.html">Proposal/Invoice</a><a href="lady-d-project-dashboard.html">Live dashboard</a><a href="lady-d-state-of-the-union-2026-07-08.html">State</a><a href="lady-d-plan-of-attack-2026-07-08.html">Plan</a><a href="lady-d-author-site.html">Lady D site</a><a href="release-status.html">Release dashboard</a></nav>',
        html,
        count=1,
        flags=re.S,
    )
    card = f"""<section id="business-hub-lane" class="card notice"><h2>Proposal & Execute-Ready Invoice</h2><p>The corrected package now has a robust proposal/invoice page like the Oakwood hub: viewable HTML proposal, downloadable PDF invoice/proposal, {money(PACKAGE_TOTAL)} package total, {money(PAID_TOTAL)} paid, {money(BALANCE_DUE)} balance due, live dashboard, State of the Union, Plan of Attack, and future Lady D product website.</p><p><a class="btn gold" href="susan-damon-publishing-proposal.html">View proposal</a><a class="btn" href="susan-damon-publishing-proposal.pdf">Download PDF</a><a class="btn" href="{PAYMENT_LINK}">Prepare {money(BALANCE_DUE)} Stripe link</a><a class="btn" href="lady-d-project-dashboard.html">Live dashboard</a><a class="btn" href="lady-d-state-of-the-union-2026-07-08.html">State of the Union</a><a class="btn" href="lady-d-plan-of-attack-2026-07-08.html">Plan of Attack</a></p></section>"""
