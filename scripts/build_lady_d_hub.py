...
MASTER_DELIVERY_PACKAGE = "downloads/production/Lady-D-Complete-Publishing-Deliverables-2026-07-19.zip"
...
EDITORIAL_NEXT_ACTION = (
    "Manuscript gates cleared; collect Lady D's final author approval, then proceed to KDP Previewer and physical-proof review."
...
CONTENT_STATUS = (
    "Transcript-directed rewrite and independent manuscript gates complete; Lady D's final author approval, KDP Previewer, and physical proof remain pending."
    if QUALITY["manuscript_gates_pass"]
