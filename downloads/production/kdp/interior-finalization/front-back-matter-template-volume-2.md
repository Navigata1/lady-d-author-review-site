# Walking with Jesus - KDP Front and Back Matter Template
...
- Current companion journal review pages: 81

## Recommended Front Matter Order

1. Half-title page: `Walking with Jesus`
2. Series page: `Lady D Devotional Library`
3. Title page: `Walking with Jesus` / `A 365-Day Devotional Journey with the Son` / `Susan "Lady D" Damon`
