# Walking with Jesus - KDP Metadata Draft
...
- Product key: `volume-2-devotional`
- Volume: 2
- Product type: Devotional
...
- Current white-paper cover working size: 13.038 x 9.250 in
- Current cream-paper cover working size: 13.125 x 9.250 in
...
- Interior PDF: `downloads/production/kdp/interior-drafts/volume-2/volume-2-full-6x9-interior-draft.pdf`
- Full-wrap cover PDF: `downloads/production/kdp/full-wrap-drafts/volume-2-path-route-white-paper-full-wrap-draft.pdf`
