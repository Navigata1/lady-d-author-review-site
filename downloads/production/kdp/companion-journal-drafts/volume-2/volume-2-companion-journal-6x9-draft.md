# Volume 2 Companion Journal 6x9 Draft
...
- Journal subtitle: A Companion Journal for Following the Son
- Devotional lane: Jesus the Son
- Author: Susan "Lady D" Damon
- Trim: 6 x 9 inches, no bleed interior draft
- Daily reflection pages: 365
- February 29 bonus pages: 1
- Prayer pages: 54
- Review / bridge pages: 54
- Rendered PDF pages: 477
- White-paper full-wrap working size from this draft: 13.324 x 9.250 in
- Cream-paper full-wrap working size from this draft: 13.443 x 9.250 in
- Source: `downloads/production/master/volume-2-master-companion-journal.md`

## Judge And Auditor Loop Applied

1. Editorial judge: keep prompts plain, direct, and usable beside the devotional.
2. Theological auditor: preserve Jesus the Son, grace-before-performance, and Adventist Sabbath frame.
