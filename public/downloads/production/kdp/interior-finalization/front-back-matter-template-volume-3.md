...
1. Half-title page: `Filled with the Holy Spirit`
2. Series page: `Lady D Devotional Library`
3. Title page: `Filled with the Holy Spirit` / `A 365-Day Devotional Journey of Power, Comfort, and Fire` / `Susan "Lady D" Damon`
