# Surrendering to God's Love - KDP Front and Back Matter Template
...
1. Half-title page: `Surrendering to God's Love`
2. Series page: `Lady D Devotional Library`
3. Title page: `Surrendering to God's Love` / `A 365-Day Devotional Journey into the Father's Heart` / `Susan "Lady D" Damon`
