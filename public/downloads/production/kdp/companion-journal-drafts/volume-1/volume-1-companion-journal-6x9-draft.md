# Volume 1 Companion Journal 6x9 Draft
...
- Journal subtitle: A Companion Journal for Receiving the Father's Heart
- Devotional lane: God the Father
- Author: Susan "Lady D" Damon
- Trim: 6 x 9 inches, no bleed interior draft
- Daily reflection pages: 365
- February 29 bonus pages: 1
- Prayer pages: 45
- Review / bridge pages: 56
- Rendered PDF pages: 470
- White-paper full-wrap working size from this draft: 13.308 x 9.250 in
- Cream-paper full-wrap working size from this draft: 13.425 x 9.250 in
- Source: `downloads/production/master/volume-1-master-companion-journal.md`

## Judge And Auditor Loop Applied

1. Editorial judge: keep prompts plain, direct, and usable beside the devotional.
2. Theological auditor: preserve God the Father, grace-before-performance, and Adventist Sabbath frame.
