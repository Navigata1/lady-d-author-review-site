# Volume 3 Companion Journal 6x9 Draft
...
- Journal subtitle: A Companion Journal for Spirit-Filled Surrender
- Devotional lane: The Holy Spirit
- Author: Susan "Lady D" Damon
- Trim: 6 x 9 inches, no bleed interior draft
- Daily reflection pages: 365
- February 29 bonus pages: 1
- Prayer pages: 57
- Review / bridge pages: 57
- Rendered PDF pages: 483
- White-paper full-wrap working size from this draft: 13.338 x 9.250 in
- Cream-paper full-wrap working size from this draft: 13.457 x 9.250 in
- Source: `downloads/production/master/volume-3-master-companion-journal.md`

## Judge And Auditor Loop Applied

1. Editorial judge: keep prompts plain, direct, and usable beside the devotional.
2. Theological auditor: preserve The Holy Spirit, grace-before-performance, and Adventist Sabbath frame.
